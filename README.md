About pingouin-feedstock
========================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/pingouin-feedstock/blob/main/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=2333&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/pingouin-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `pingouin` can be installed with `conda`:
...
It is possible to list all of the versions of `pingouin` available on your platform with `conda`:
...
```
mamba search pingouin --channel conda-forge
```
...
mamba repoquery search pingouin --channel conda-forge

# List packages depending on `pingouin`:
mamba repoquery whoneeds pingouin --channel conda-forge

# List dependencies of `pingouin`:
mamba repoquery depends pingouin --channel conda-forge
```
